    ...
    render() {
        ...
        return (
          <section className='slider-container'>
            <h2 data-aos="flip-right" className='text-center text-[1.7rem] sm:text-3xl lg:text-3xl mt-[20rem] sm:mt-[20rem] md:mt-[10rem] lg:mt-32 2xl:text-4xl'> Most Popular Tours</h2>
